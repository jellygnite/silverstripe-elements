...
var combineParams$11 = util.combineParams;

function AnyMeeting() {
  this.provider = 'anymeeting';
  this.defaultFormat = 'long';
  this.formats = {
    long: this.createLongUrl,
    embed: this.createEmbedUrl
...
AnyMeeting.prototype.parseUrl = function (url, result) {
  var match = url.match(/(anymeeting\.com)(\/[^\r\n]*)?/i);
...
AnyMeeting.prototype.parseParameters = function (params) {  
  return params;
};


AnyMeeting.prototype.parse = function (url, params) {
  var result = {
    mediaType: this.mediaTypes.VIDEO,
    params: this.parseParameters(params)
  };
...
AnyMeeting.prototype.createUrl = function (baseUrl, vi, params) {
  if (!vi.id || vi.mediaType !== this.mediaTypes.VIDEO) {
    return undefined;
  }
  var url = baseUrl + vi.id;
...
AnyMeeting.prototype.createLongUrl = function (vi, params) {
  return this.createUrl('https://anymeeting.com/', vi, params);
};

AnyMeeting.prototype.createEmbedUrl = function (vi, params) {
  return this.createUrl('//anymeeting.com/video/', vi, params);
};

base.bind(new AnyMeeting());
